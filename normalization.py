...
class Normalizer(object):
    ...
    def __init__(self,devicetype="GPU"):
        ...
        self.verbose = True
        self.frames_folder = "/home/paleo/Titanium"
        self.corrected_folder = "testframes"
        self.aligned_folder = "aligned"
        self.darkprefix = 'Ti_fast_dark_'
        self.dataprefix = 'Ti_fast_data_'
        self.flatprefix = 'Ti_fast_ref_'
        self.suffix = ".edf"
        
        self.devicetype = devicetype
        kernel_path = "openCL/correction.cl" 
        kernel_src = open(kernel_path).read()
        self.device = ocl.select_device(type=devicetype, memory=None, best=True)
        ...
        for data_fullname in listData:
            ...
            for ref_fullname in listFlats:
                ...
                if ref_id == data_id:
                    ...
                    ex1 = fabio.open(ref_fullname).header["exposure_time"]
                    #get the corresponding Dark ("dark data")
                    dark_data = arrayDarks[ex1]
                    dark1 = ref
...
#                scipy.misc.imsave(self.corrected_folder + "/frame" + data_id +".png", cor.astype("float32"))
